...
#define STABILIZE_ONLY_THROTTLE_MANUAL 2
#endif
...
unsigned long channel_5_fs = 1000; // gear, less than 1500 = throttle cut
...
float Ki_roll_rate = 0.20;    // Roll I-gain - rate mode
float Kd_roll_rate = 0.0008;  // Roll D-gain - rate mode (be careful when increasing too high, motors will begin to overheat!)
...
const int ch4Pin = 9;  // rudd
const int ch5Pin = 8;  // gear (throttle cut)
...
const int servo5Pin = 41;
const int servo6Pin = 39;
const int servo7Pin = 38;
...
float roll_des_from_i2c = 0, pitch_des_from_i2c = 0, yaw_des_from_i2c = 0;
 ...
 */
  ...
  {
#ifdef BLUETOOTH_EN
    Serial8.println("MPU9250 initialization unsuccessful");
...
#ifdef BLUETOOTH_EN
  Serial8.print("float AccErrorX = ");
  Serial8.print(AccErrorX);
  Serial8.println(";");
  Serial8.print("float AccErrorY = ");
  Serial8.print(AccErrorY);
  Serial8.println(";");
  Serial8.print("float AccErrorZ = ");
  Serial8.print(AccErrorZ);
  Serial8.println(";");

  Serial8.print("float GyroErrorX = ");
  Serial8.print(GyroErrorX);
  Serial8.println(";");
  Serial8.print("float GyroErrorY = ");
  Serial8.print(GyroErrorY);
  Serial8.println(";");
  Serial8.print("float GyroErrorZ = ");
  Serial8.print(GyroErrorZ);
  Serial8.println(";");
...
void getDesState()
{
  ...
  case ALTITUDE_HOLD_AUTO:
    ...
    yaw_des = constrain(yaw_des + yaw_des_from_i2c, -1.0, 1.0) * maxYaw;
    break;
#endif

#ifdef STABILIZE_ONLY_THROTTLE_MANUAL
  case STABILIZE_ONLY_THROTTLE_MANUAL:
    thro_des = (channel_1_pwm - 1000.0) / 1000.0; // Between 0 and 1; // specify throtle based on height
                                                  // roll des , pitch des , yaw des specified by raspberry
                                                  // roll_passthru = roll_des_from_i2c / 2.0;                         // Between -0.5 and 0.5
                                                  // pitch_passthru = pitch_des_from_i2c / 2.0;                       // Between -0.5 and 0.5
                                                  // yaw_passthru = yaw_des_from_i2c / 2.0;                           // Between -0.5 and 0.5
...
void getCommands()
{
  ...
  {
    // Serial8.println("*** DSM RX TIMED OUT ***");
  }
...
void calibrateMagnetometer()
{
  ...
  float success;
#ifdef BLUETOOTH_EN
  Serial8.println("Beginning magnetometer calibration in");
  Serial8.println("3...");
  delay(1000);
  Serial8.println("2...");
  delay(1000);
  ...
  {
#ifdef BLUETOOTH_EN
    Serial8.println("Calibration Successful!");
    Serial8.println("Please comment out the calibrateMagnetometer() function and copy these values into the code:");
    Serial8.print("float MagErrorX = ");
    Serial8.print(mpu9250.getMagBiasX_uT());
    Serial8.println(";");
    Serial8.print("float MagErrorY = ");
    Serial8.print(mpu9250.getMagBiasY_uT());
    Serial8.println(";");
    Serial8.print("float MagErrorZ = ");
    Serial8.print(mpu9250.getMagBiasZ_uT());
    Serial8.println(";");
    Serial8.print("float MagScaleX = ");
    Serial8.print(mpu9250.getMagScaleFactorX());
    Serial8.println(";");
    Serial8.print("float MagScaleY = ");
    Serial8.print(mpu9250.getMagScaleFactorY());
    Serial8.println(";");
    Serial8.print("float MagScaleZ = ");
    Serial8.print(mpu9250.getMagScaleFactorZ());
    Serial8.println(";");
    Serial8.println(" ");
...
void log_data()
{
  ...
  else
  {
    ...
    if (file_opened && !error_occured)
    {
      ...
      logfile.print(",  ");
#endif
      logfile.print(flight_mode == 1 ? "Altitudehold" : flight_mode == 0 ? "Stabalize"
                                                                         : "STABILIZE_AUTO");
      logfile.print(",  ");
      logfile.print(roll_IMU);
      logfile.print(",  ");
      logfile.print(pitch_IMU);
      logfile.print(",  ");
      logfile.println(yaw_IMU);
...
#ifdef BLUETOOTH_EN
    Serial8.print(F(" CH1: "));
    Serial8.print(channel_1_pwm);
    Serial8.print(F(" CH2: "));
    Serial8.print(channel_2_pwm);
    Serial8.print(F(" CH3: "));
    Serial8.print(channel_3_pwm);
    Serial8.print(F(" CH4: "));
    Serial8.print(channel_4_pwm);
    Serial8.print(F(" CH5: "));
...
void printDesiredState()
{
  if (current_time - print_counter > 10000)
  {
    print_counter = micros();
#ifdef BLUETOOTH_EN
    Serial8.print(F("thro_des: "));
    Serial8.print(thro_des);
    Serial8.print(F(" roll_des: "));
    Serial8.print(roll_des);
    Serial8.print(F(" pitch_des: "));
...
void printGyroData()
{
  if (current_time - print_counter > 10000)
  {
    print_counter = micros();
#ifdef BLUETOOTH_EN
    Serial8.print(F("GyroX: "));
    Serial8.print(GyroX);
    Serial8.print(F(" GyroY: "));
    Serial8.print(GyroY);
...
{ // dont exceed 2000 hz untested
  ...
  if (distance != 255)
    altitude_of_quad_from_ultrasonic = distance / 100.0;
}
#endif
...
#ifdef STABILIZE_ONLY_THROTTLE_MANUAL
  else if (channel_6_pwm < 1800 && channel_6_pwm > 1500)
  {
    flight_mode = STABILIZE_ONLY_THROTTLE_MANUAL;
  }
...
void printAccelData()
{
  if (current_time - print_counter > 10000)
  {
    print_counter = micros();
#ifdef BLUETOOTH_EN
    Serial8.print(F("AccX: "));
    Serial8.print(AccX);
    Serial8.print(F(" AccY: "));
    Serial8.print(AccY);
    Serial8.print(F(" AccZ: "));
    Serial8.println(AccZ);
#endif
    Serial.print(F("AccX: "));
    Serial.print(AccX);
    Serial.print(F(" AccY: "));
...
void printMagData()
{
  if (current_time - print_counter > 10000)
  {
    print_counter = micros();
#ifdef BLUETOOTH_EN
    Serial8.print(F("MagX: "));
    Serial8.print(MagX);
    Serial8.print(F(" MagY: "));
    Serial8.print(MagY);
...
void printRollPitchYaw()
{
  if (current_time - print_counter > 10000)
  {
    print_counter = micros();
#ifdef BLUETOOTH_EN
    Serial8.print(F("roll: "));
    Serial8.print(roll_IMU);
    Serial8.print(F(" pitch: "));
    Serial8.print(pitch_IMU);
    Serial8.print(F(" yaw: "));
    Serial8.println(yaw_IMU);
#endif
    Serial.print(F("roll: "));
...
void printPIDoutput()
{
  if (current_time - print_counter > 10000)
  {
    print_counter = micros();
#ifdef BLUETOOTH_EN
    Serial8.print(F("roll_PID: "));
    Serial8.print(roll_PID);
    Serial8.print(F(" pitch_PID: "));
    Serial8.print(pitch_PID);
    Serial8.print(F(" yaw_PID: "));
    Serial8.println(yaw_PID);
#endif
...
void printMotorCommands()
{
  if (current_time - print_counter > 10000)
  {
    print_counter = micros();
#ifdef BLUETOOTH_EN
    Serial8.print(F("m1_command: "));
    Serial8.print(m1_command_PWM);
    Serial8.print(F(" m2_command: "));
    Serial8.print(m2_command_PWM);
    Serial8.print(F(" m3_command: "));
    Serial8.print(m3_command_PWM);
    Serial8.print(F(" m4_command: "));
    Serial8.print(m4_command_PWM);
    Serial8.print(F(" m5_command: "));
    Serial8.print(m5_command_PWM);
    Serial8.print(F(" m6_command: "));
    Serial8.println(m6_command_PWM);
#endif
...
void printServoCommands()
{
  if (current_time - print_counter > 10000)
  {
    print_counter = micros();
#ifdef BLUETOOTH_EN
    Serial8.print(F("s1_command: "));
    Serial8.print(s1_command_PWM);
    Serial8.print(F(" s2_command: "));
    Serial8.print(s2_command_PWM);
    Serial8.print(F(" s3_command: "));
    Serial8.print(s3_command_PWM);
    Serial8.print(F(" s4_command: "));
    Serial8.print(s4_command_PWM);
    Serial8.print(F(" s5_command: "));
    Serial8.print(s5_command_PWM);
    Serial8.print(F(" s6_command: "));
    Serial8.print(s6_command_PWM);
    Serial8.print(F(" s7_command: "));
    Serial8.println(s7_command_PWM);
#endif
